namespace AdventOfCode._2020
{
    ...
    public class RainRisk : Day
    {
        public RainRisk() : base(12) {}
        ...
        private int Manhattanize(string input)
        {
            ...
            foreach(var i in input.Split('\n'))
            {
                ...
                {
                    case 'N':
                        y += int.Parse(i.Substring(1));
                        break;
                    case 'S':
                        y -= int.Parse(i.Substring(1));
                        break;
                    case 'E':
                        x += int.Parse(i.Substring(1));
                        break;
                    case 'W':
                        x -= int.Parse(i.Substring(1));
                        break;
                    case 'L':
                        facing -= int.Parse(i.Substring(1));
                    ...
                    case 'F':
                        switch(facing)
                        {
                            ...
                            case 270:
                                ...
                                break;
                            default:
                                throw new Exception($"Wrong turn somewhere {i} {x} {y} {facing}");
                        }
                        break;
                    default:
                        throw new Exception($"i[0] is not a valid instruction jackass");
                }
            }
        ...
        private int WaypointManhattanize(string input)
        {
            var waypointX = 10;
            var waypointY = 1;
            ...
            foreach(var i in input.Split('\n'))
            {
                ...
                {
                    case 'N':
                        waypointY += int.Parse(i.Substring(1));
                        break;
                    case 'S':
                        waypointY -= int.Parse(i.Substring(1));
                        break;
                    case 'E':
                        waypointX += int.Parse(i.Substring(1));
                        break;
                    case 'W':
                        waypointX -= int.Parse(i.Substring(1));
                        break;
                    case 'L':
                        for(var j = 0; j < int.Parse(i.Substring(1)); j+= 90)
                        {
                    ...
                    case 'R':
                        ...
                        break;
                    case 'F':
                        shipX += waypointX * int.Parse(i.Substring(1));
                        shipY += waypointY * int.Parse(i.Substring(1));
                        break;
                    default:
                        throw new Exception($"i[0] is not a valid instruction jackass");
                }
...
F11";
        ...
        private const string MainInput = @"N4
R90
E1
L90
S5
